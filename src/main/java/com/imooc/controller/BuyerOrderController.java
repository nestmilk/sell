...
/**
 * @ Author     ：nestmilk
 * @ Date       ：Created in  2018/6/24 13:20
 */
@RestController
...
public class BuyerOrderController {
    ...
    public ResultVO<Map<String,String>> create(@Valid OrderForm orderForm,
        ...
        if(bindingResult.hasErrors()){
            ...
            throw new SellExcetption(ResultEnum.PARAM_ERROR.getCode(),
        ...
        if(CollectionUtils.isEmpty(orderDTO.getOrderDetailList())){
            ...
            throw new SellExcetption(ResultEnum.CART_EMPTY);
        }
    ...
    public ResultVO<List<OrderDetail>> list(@RequestParam("openid") String openid,
        ...
        if(StringUtils.isEmpty(openid)){
            ...
            throw new SellExcetption(ResultEnum.PARAM_ERROR);
        }
