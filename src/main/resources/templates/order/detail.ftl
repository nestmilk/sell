        ...
        <#--边栏sidebar-->
            ...
            <div id="page-content-wrapper">
                ...
                <#if orderDTO.getOrderStatusEnum().getCode()==0>
                    <a href="/sell/seller/order/finish?orderId=${orderDTO.getOrderId()}&page=${page}" type="button" class="btn btn-default btn-primary">完结订单</a>
                    <#if orderDTO.getPayStatusEnum().getCode()==1>
                        <a href="/sell/seller/order/cancel?orderId=${orderDTO.getOrderId()}&page=${page}" type="button" class="btn btn-default btn-danger">取消订单</a>
                    </#if>
                </#if>
                        </div>
                    </div>
